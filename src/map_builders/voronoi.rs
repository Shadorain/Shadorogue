...
impl VoronoiBuilder {
    ...
    #[allow(dead_code)]
    pub fn chebyshev () -> Box<VoronoiBuilder> {
        Box::new(VoronoiBuilder {
            n_seeds: 64,
            ...
            for (seed, pos) in voronoi_seeds.iter().enumerate() {
                ...
                match self.distance_algorithm {
                    DistanceAlgorithm::Pythagoras => {
                        dist = rltk::DistanceAlg::PythagorasSquared.distance2d(
                            rltk::Point::new(x,y), pos.1);
                    },
                    DistanceAlgorithm::Manhattan => {
                        dist = rltk::DistanceAlg::Manhattan.distance2d(
                            rltk::Point::new(x,y), pos.1);
                    },
                    DistanceAlgorithm::Chebyshev => {
                        dist = rltk::DistanceAlg::Chebyshev.distance2d(
                            rltk::Point::new(x,y), pos.1);
                    },
                }
